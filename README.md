...
```javascript
COMPLEX128_NAN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex128-nan@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-complex128-nan/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/constants-complex128-nan/actions/workflows/test.yml?query=branch:v0.2.2
